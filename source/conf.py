...
html_logo = "_static/tigerjython-logo.png"
html_favicon = "https://gitlab.inf.ethz.ch/uploads/-/system/project/avatar/26084/tigerjython-docs-icon.png"
...
latex_documents = [
    ("index", "webtj3-docs.tex", infos.title, infos.author, "manual"),
]
